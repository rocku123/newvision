...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Edit User Donation</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Edit User Donation</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            <div class="card card-outline card-primary">
              <div class="card-header">
                <h3 class="card-title">Edit User Donation</h3>
              ...
              <div class="card-body" style="display: block;">
                  <form role="form" id="UpdateuserDonationForm" novalidate="novalidate">
                    <div class="card-body">
                      <div class="row">
                          <div class="col-lg-6 col-sm-6">
                            ...
                            <select class="form-control select2" name="user_id"  style="width: 100%;">
                                ...
                                <?php foreach($users as $user){ 
                                  $selected = $user->id==$list->user_id?"selected":"";
                                  ?>
