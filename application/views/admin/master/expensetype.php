          ...
          <div class="col-md-12">
            <div class="card card-outline card-primary collapsed-card">
              ...
              <div class="card-body" style="display: none;">
                  <form role="form" id="masterForm" action="<?=base_url('admin/master/add_expensetype_act')?>" novalidate="novalidate" method="post">
                    <div class="card-body">
                      <div class="row">
              ...
              <div class="card-body">
                ...
                foreach($lists as $list) {   ?>
                    <tr>
                        ...
                        <a href="<?=base_url(); ?>admin/master/deleteExpensetype/<?=$list->id ?>" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
                <?php  
                 $i++;
